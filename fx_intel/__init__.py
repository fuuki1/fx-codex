...
15. timeframe    — 15m/1h/4h/1d を独立に判断(各足に主ホライズンを紐付け)
16. price_history — 採点用の将来価格調達(ジャーナル後続行 + 外部OHLC注入口)
17. tf_learning  — (symbol×timeframe) セル別の主ホライズン採点・学習
18. tf_briefing  — 時間足別のDiscordペイロード生成
19. trade_outcome — MFE/MAE/TP/SL採点・期待値監査・改善候補レジストリ
20. tp_sl_learning — TP/SL先着正答率によるMVP確信度補正
21. maximization — 期待R/PF/Brier/経路品質による最大化プロファイル
